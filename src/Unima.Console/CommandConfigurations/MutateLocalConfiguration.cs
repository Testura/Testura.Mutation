...
namespace Unima.Console.CommandConfigurations
{
    public class MutateLocalConfiguration
    {
        public static void Configure(CommandLineApplication app)
        {
            ...
            var configPath = app.Option("-cp|--configPath", "Required. Path to unima config", CommandOptionType.SingleValue).IsRequired();
